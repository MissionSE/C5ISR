...
public class SettingsActivity extends PreferenceActivity {
	...
	public static class UnitsPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// guidelines.
			bindPreferenceSummaryToValue(findPreference("com_missionse_kestrelweather_temperature_units"));
			bindPreferenceSummaryToValue(findPreference("com_missionse_kestrelweather_windspeed_units"));
			bindPreferenceSummaryToValue(findPreference("com_missionse_kestrelweather_pressure_units"));
			bindPreferenceSummaryToValue(findPreference("com_missionse_kestrelweather_rainfall_units"));
		}
	}
