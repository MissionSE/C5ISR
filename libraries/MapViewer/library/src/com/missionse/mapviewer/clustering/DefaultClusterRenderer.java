...
import com.missionse.mapviewer.R;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
	...
	private ClusterInfoWindowAdapter<T> mInfoWindowAdapter;
	private ClusterItemInfoWindowAdapter<T> mItemInfoWindowAdapter;
	...
	public void onAdd() {
		...
		mClusterManager.getMarkerCollection().setOnInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
			...
			public View getInfoWindow(Marker marker) {
				View view = null;
				if (mItemInfoWindowAdapter != null) {
					view = mItemInfoWindowAdapter.getClusterItemInfoWindow(marker, mMarkerCache.get(marker));
				}
				return view;
			}
			...
			public View getInfoContents(Marker marker) {
				View view = null;
				if (mItemInfoWindowAdapter != null) {
					view = mItemInfoWindowAdapter.getClusterItemInfoContents(marker, mMarkerCache.get(marker));
				}
				return view;
			}
		});
		...
		mClusterManager.getClusterMarkerCollection().setOnInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
			...
			public View getInfoWindow(Marker marker) {
				...
				if (mInfoWindowAdapter != null) {
					view = mInfoWindowAdapter.getClusterInfoWindow(marker, mMarkerToCluster.get(marker));
				}
				return view;
			}
			...
			public View getInfoContents(Marker marker) {
				View view = null;
				if (mInfoWindowAdapter != null) {
					view = mInfoWindowAdapter.getClusterInfoContents(marker, mMarkerToCluster.get(marker));
				}
				return view;
			}
		});
	...
	public void setClusterItemInfoWindowAdapter(ClusterItemInfoWindowAdapter<T> adapter) {
		mItemInfoWindowAdapter = adapter;
	}

	public void setClusterInfoWindowAdapter(ClusterInfoWindowAdapter<T> adapter) {
